...
public class DiBiaoZhiLv2Activity extends AutoLayoutActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_di_biao_zhi_lv2);
        initView();
    }

    private void initView() {
        TextView tv_title = (TextView)findViewById(R.id.tv_title);
        tv_title.setText("甘南年则保玉秋色");
